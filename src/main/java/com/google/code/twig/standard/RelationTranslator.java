...
public class RelationTranslator implements PropertyTranslator
{
	...
	public Object decode(Set<Property> properties, Path prefix, Type type)
	{
      ...
      Collection<Object> keyInstances = keysToInstances(keys);
      if (Generics.erase(type).equals(Set.class)) {
        return Sets.newHashSet(keyInstances);
      }
      return keyInstances;
    }
		else
